...
\begin{example}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}[tdplot_main_coords]
            ...
            \node at (P1) {$\fvec p_1' = \qty(E_1', \vec p_1')$};
            ...
            \tdplotdrawarc[tdplot_rotated_coords]{(0,0,0)}{1}{30}{90}{anchor = north east}{$\theta$};
            \tdplotdrawarc[tdplot_rotated_coords, -latex, myblue]{(0,0,0)}{2}{30}{0}{anchor = south}{incr. $\fvec q^2$};
            %
